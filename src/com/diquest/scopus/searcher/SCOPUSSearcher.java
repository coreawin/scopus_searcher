...
public class SCOPUSSearcher {
	...
	public SCOPUSSearcher(String searchRule) throws Exception {
	...
	public static void main(String... args) throws Exception {
		...
		String readfile = "./이창환/AI쿼리.2015-2017.20190801.txt";
		...
		// searchRule = " EID=(85044590526 85020118974)";
		// args = new String[] {
		// "d:\\data\\scopus\\김정환박사\\201809\\1sample_tsv_", };
		// if (args != null) {
		// try {
		// downloadPath = args[0];
		// new File(downloadPath).getParentFile().mkdirs();
		...
		// downloadPath =
		// String.format("d://data/scopus/김정환박사/20181007/SCOPUS_KOR_DOCUMENT_%s.tsv",
		// idx);
		// new File(downloadPath).getParentFile().mkdirs();
