package com.diquest.scopus.searcher._2021.Rnd;
...
public class ScopusSearcher_2021 {
	...
	public static void main(String... args) throws Exception {
		...
		String[] 분과명정보 = new String[] {  "고기능무인기", "수소에너지", "스마트그리드", "스마트팜", "시스템반도체", "연료전지", "인공지능", "정밀의료", "지능형로봇", "친환경차", "태양광" };
//		 분과명정보 = new String[] {
//				 "스마트그리드", "지능형로봇", "시스템반도체"
//		 };
		 분과명정보 = new String[] {
		 ...
		 분과명정보 = new String[] {  "미세먼지" };
		String downloadDateFormat = "20210323";
		...
		for (String 분과명 : 분과명정보) {
			String searchRuleFilePath = "D:/eclipse_workspace/workspace_luna/public/NEON_ECLIPSE_KISTI_SCOPUS_SEARCHER/2021/0109/"
					+ 분과명 + File.separator;
...
//				if(true) System.exit(0);
				...
				for (String 검색식아이디 : 검색식아이디정보) {
					...
					dp = String.format(dp + File.separator + downloadDateFormat + "\\%s\\scopus\\%s.txt", 분과명, techID+ "_" +  techName
